...
def config_transport_delivery_appt(csrf, load_numbers):
...
def config_update_delivery_appt(csrf, load_numbers, appt_date, appt_time):
    data_dict = config_update_pickup_appt(csrf, load_numbers, appt_date, appt_time)
